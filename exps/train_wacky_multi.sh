...
mkdir modelfiles
./multift skipgram -input "/efs/users/benathi/research/data/ukwac_wackypedia.txt" -output modelfiles/multi_wacky_e10_d300_vs2e-4_lr1e-5_margin1 -lr 1e-5 -dim 300 \
